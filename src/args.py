...
class ScriptArguments:
    ...
    use_nested_quant: Optional[bool] = field(
        default=False, metadata={"help": "Activate "}
    )
    ...
    bnb_4bit_quant_type: Optional[str] = field(
        default="nf4", metadata={"help": "Quantization type, can be fp4 or nf4"}
    )
    ...
    fp16: Optional[bool] = field(
        default=False, metadata={"help": "Enables fp16 training."}
    )
    bf16: Optional[bool] = field(
        default=True, metadata={"help": "Enables bf16 training."}
    )
    ...
    warmup_steps: Optional[int] = field(
        default=1_000, metadata={"help": "Number of steps to do a warmup for."}
    )
    ...
    save_steps: Optional[int] = field(
        default=200, metadata={"help": "Save checkpoint every X update steps."}
    )
    logging_steps: Optional[int] = field(
        default=5, metadata={"help": "Log every X update steps."}
    )
